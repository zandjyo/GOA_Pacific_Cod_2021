...
# 3 8 #_min and max age over which average F will be calculated, with F=Z-M
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1626476656
